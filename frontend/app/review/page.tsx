...
export default function Review() {
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="pt-24 pb-20 px-5 md:max-w-3xl md:mx-auto">
        {/* Product Brief */}
        <section className="flex gap-6 items-center mb-10">
          <div className="w-32 h-40 bg-surface-container-highest overflow-hidden rounded-2xl border border-outline-variant/20 flex-shrink-0 shadow-sm">
            <img 
              alt="Product" 
          ...
          <div className="flex flex-col gap-2">
            <h2 className="font-display text-4xl tracking-tighter uppercase leading-none text-on-surface">NEO-TOKYO TECH SHELL V1</h2>
            <div className="mt-1">
        ...
        {/* Rating Stars */}
        <section className="mb-12 text-center py-10 glass-card rounded-3xl border border-outline-variant/10 shadow-sm">
          ...
          <div className="flex justify-center gap-5">
            {[1, 2, 3, 4, 5].map((s) => (
              <Star 
                key={s} 
                size={36} 
                className={s <= 4 ? "text-secondary fill-secondary" : "text-outline-variant"} 
              />
            ))}
          </div>
        </section>
        ...
        <section className="mb-12 space-y-10">
          <div className="border-l-4 border-secondary pl-5 py-1">
            <h3 className="font-display text-4xl leading-none uppercase text-on-surface">VAULT SIZING ENGINE DATA</h3>
        ...
        <section className="mb-20 space-y-6">
          ...
          <div className="flex gap-4 overflow-x-auto pb-4 no-scrollbar">
            <label className="w-28 h-28 flex-shrink-0 border-2 border-dashed border-outline-variant/40 rounded-2xl flex flex-col items-center justify-center cursor-pointer hover:bg-surface-container transition-all group">
            ...
            <div className="w-28 h-28 flex-shrink-0 rounded-2xl overflow-hidden border border-outline-variant/20 relative group shadow-sm">
              <img 
                alt="Fit pic" 
        ...
        {/* Submit */}
        <button className="w-full py-6 chrome-effect rounded-2xl font-display text-4xl text-secondary tracking-widest active:scale-[0.98] transition-all uppercase shadow-xl shadow-secondary/5 group overflow-hidden">
