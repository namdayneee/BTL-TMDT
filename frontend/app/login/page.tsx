        ...
        <div className="relative z-10 flex flex-col justify-between p-14 h-full">
          ...
          <div>
            ...
            <p className="font-body text-sm text-surface/60 max-w-xs leading-relaxed">
              Hệ sinh thái thời trang cho những tâm hồn khác biệt. Đăng nhập để khám phá thế giới Vault.
            </p>
        ...
        >
          ...
          <form onSubmit={handleLogin} className="glass-card rounded-3xl p-8 space-y-8 shadow-2xl relative overflow-hidden">
            ...
            <div className="space-y-4">
              ...
              <div className="relative">
                ...
                <input
                  className="w-full bg-white/30 border-0 border-b border-outline-variant py-4 pl-16 pr-4 font-body text-sm text-on-surface placeholder:text-outline-variant focus:ring-0 focus:border-secondary transition-all outline-none"
            ...
            <button
              type="button"
              className="w-full h-14 rounded-2xl glass-card border border-outline-variant/20 hover:bg-white/50 transition-colors flex items-center justify-center space-x-3"
            >
          ...
          <footer className="mt-10 text-center space-y-5">
            <p className="font-body text-on-surface-variant text-sm">
              Chưa có tài khoản? <a className="text-secondary font-bold underline underline-offset-4 cursor-pointer" href="#">ĐĂNG KÝ NGAY</a>
            </p>
            <div className="lg:hidden flex justify-center items-center space-x-6 opacity-40">
              <ShieldCheck size={18} />
