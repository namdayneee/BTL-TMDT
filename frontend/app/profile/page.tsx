...
export default function Profile() {
  return (
    <div className="min-h-screen bg-surface">
      ...
      <main className="pt-24 pb-20 px-5 max-w-md mx-auto space-y-8">
        {/* User Profile */}
        <section className="flex flex-col items-center text-center">
          <div className="relative group">
            <div className="absolute -inset-1.5 bg-gradient-to-r from-secondary via-secondary-fixed-dim to-secondary rounded-full blur opacity-30 group-hover:opacity-60 transition duration-1000"></div>
            <div className="relative w-32 h-32 rounded-full overflow-hidden border-2 border-white/50 bg-surface-container shadow-2xl">
              <img 
          ...
          <h1 className="mt-6 font-display text-5xl uppercase tracking-widest text-on-surface">KHANH NGUYEN</h1>
        ...
        {/* Exclusive Drops */}
        <section className="relative overflow-hidden rounded-3xl bg-on-surface p-8 text-surface shadow-2xl">
          <div className="absolute top-0 right-0 p-6 opacity-10">
            <Rocket size={80} />
          </div>
          <div className="relative z-10">
            <p className="font-tech text-[10px] text-secondary-fixed-dim uppercase mb-2 tracking-[0.3em] font-bold opacity-80">Truy Cập Độc Quyền</p>
            <h3 className="font-tech text-lg font-bold mb-6 tracking-tight">MỞ BÁN SS.24 SAU 02:14:55</h3>
            <button className="w-full py-4 bg-surface text-on-surface font-tech text-[10px] font-bold uppercase tracking-[0.3em] active:scale-95 transition-all rounded-xl shadow-lg">
              Thông Báo Cho Tôi
            </button>
          </div>
        </section>
        ...
        <section className="space-y-4">
          ...
          <div className="glass-card rounded-3xl p-10 relative overflow-hidden group">
            ...
            <div className="relative z-10 flex flex-col items-center">
              ...
              <p className="mt-5 font-body text-[11px] text-on-surface-variant text-center max-w-[200px] leading-relaxed opacity-70">
        ...
        <section className="space-y-4">
          <div className="flex justify-between items-center px-1">
            ...
            <button className="font-tech text-[10px] font-bold text-secondary underline tracking-widest">XEM TẤT CẢ</button>
          </div>
             ...
             <div className="bg-surface-container-low/50 p-4 rounded-2xl flex justify-between items-center border border-outline-variant/10">
                <div className="flex gap-4 items-center">
                  <div className="w-12 h-14 bg-surface-container rounded-xl overflow-hidden">
                    <img className="w-full h-full object-cover" src="https://lh3.googleusercontent.com/aida-public/AB6AXuD-65U2l7oMqaR0oKbjh3k5ldICkdWSt-bYTQyIIYZwzZrmsyYqvs4neMwhUeaM1NGitAfxsxv0ubzeE0c6c6Jby46dFDbBPaQL03fMNwnW-ByQMIlq6OUgyywUQT_X_0pB7znpdls5Op5L0uGqL_q5bP1Sff9RrRvFKFle4JLmRFpCvnjsIKnSxf01J3WDys5r93h0KDV7SzN-S-RWjT7qxvxs4OCvXCJmvkkNudmgUxpRR62a5cH-rLR8L7UBU2P-uDL-DNwjJzDL" alt="Product" />
                  </div>
                  <div>
